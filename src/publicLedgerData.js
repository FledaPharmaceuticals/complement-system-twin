const entries = [
  {
    ...
    recordVersion: "1.0.0",
    entryId: "ledger:contract-v1.1",
    status: "active",
    version: "complement-twin-v1.1-contract",
    baseVersion: "complement-twin-v1.0-public",
    releasedAt: "2026-08-27",
    context: { disease: "Cross-disease", tissue: "Public teaching model", pathway: "Model governance" },
    parameter: { parameterId: "governance.traceabilityContract", label: "Traceability contract", disclosureLevel: "public_summary", direction: "unchanged" },
    rationale: "Established evidence, version, uncertainty, and rollback metadata without changing biological parameters.",
    limitations: ["Governance release only", "No biological parameter change"],
    evidence: { publicationCount: 0, independentGroupCount: 0, publications: [] },
    validation: { trainingImprovementPercent: 0, holdoutImprovementPercent: 0, sentinelDegradationMaximumPercent: 0, uncertainty: "not_applicable" },
    policy: { policyId: "fleda-explicit-human-release", version: "1.0.0", releaseRoute: "human_approved_contract" },
    rollback: { version: "complement-twin-v1.0-public", status: "available" },
    comments: { count: 0, submissionEnabled: false },
  ...
  },
  {
    ...
    status: "candidate",
    version: "complement-twin-v1.2-dry-run",
    ...
    policy: { policyId: "fleda-complement-auto-release-policy", version: "1.0.0", releaseRoute: "policy_dry_run" },
    rollback: { version: "complement-twin-v1.1-contract", status: "available" },
    comments: { count: 0, submissionEnabled: false },
    formalModelChanged: false,
    synthetic: true
  },
  {
    recordType: "fleda_public_model_change_ledger_entry",
    recordVersion: "1.0.0",
    entryId: "ledger:synthetic-terminal-rejected",
    status: "rejected",
    version: "complement-twin-v1.2-rejected-synthetic",
    baseVersion: "complement-twin-v1.1-contract",
    releasedAt: null,
    context: { disease: "PNH", tissue: "Blood / RBC", pathway: "Terminal pathway" },
...
export const PUBLIC_LEDGER_ENTRIES = deepFreeze(entries);
